...
2-1 Python Platform Installation
...
2-2 Python Requests Library Installation
     Release v2.26.0. download weblink : https://docs.python-requests.org/en/latest/ 

2-3 Zendesk Ticket Viewer Installation
     Unzip ztview.zip in your working direction.

3- Run
3-1 Run Zendesk Ticket Viewer in normal mode
  step 1: Enter console window and go to your working direction.  Enter python3 ztViewer.py
  step 2: input username and password  (Username: rstli@ucdavis.edu    passsword: R@ndyli94041424)
  step 3: choose 1 or 2 on menu.

3-2 Run Zendesk Ticket Viewer in Unit Test mode
